...
# copied in here; the container never compiles. CI passes the matching
# target/<triple>/release/hodor as this build context's `hodor` file.
#
...
USER root
COPY hodor /usr/local/bin/hodor
ENTRYPOINT ["hodor"]
CMD ["serve"]